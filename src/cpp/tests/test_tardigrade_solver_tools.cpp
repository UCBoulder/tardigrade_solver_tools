...
errorOut nlFxn1(const floatVector &x, const floatMatrix &floatArgs, const intMatrix &intArgs, floatVector &residual,
                floatMatrix &jacobian, floatMatrix &floatOuts, intMatrix &intOuts) {
    /*!
...
errorOut nlFxn2(const floatVector &x, const floatMatrix &floatArgs, const intMatrix &intArgs, floatVector &residual,
                floatMatrix &jacobian, floatMatrix &floatOuts, intMatrix &intOuts) {
    /*!
    ...
    jacobian = {
        {(x[0] - 7) * x[1] + (x[0] - 1) * x[1], (x[0] - 1) * (x[0] - 7), 0                      },
...
errorOut nlFxn3(const floatVector &x, const floatMatrix &floatArgs, const intMatrix &intArgs, floatVector &residual,
                floatMatrix &jacobian, floatMatrix &floatOuts, intMatrix &intOuts) {
    /*!
...
errorOut nlFxn4(const floatVector &x, const floatMatrix &floatArgs, const intMatrix &intArgs, floatVector &residual,
                floatMatrix &jacobian, floatMatrix &floatOuts, intMatrix &intOuts) {
    /*!
     * A non-linear function for use in testing the solver which will
     * require the use of the line-search algorithm. The function is of the form
    ...
    jacobian = {{(std::cosh(x[0]) * std::cosh(x[0]) - std::sinh(x[0]) * std::sinh(x[0])) /
                 (std::cosh(x[0]) * std::cosh(x[0]))}};
    return NULL;
}

errorOut nlFxn5(const floatVector &x, const floatMatrix &floatArgs, const intMatrix &intArgs, floatVector &residual,
                floatMatrix &jacobian, floatMatrix &floatOuts, intMatrix &intOuts) {
    /*!
     ...
     *
     * \f$ intArgs = \left [ \left [ -1, -2, -3 \right ], \left [ 5, 4, 3, 2 \right ], \left [ 8, 9, 9 \right ] \right
     * ]\f$
     *
     ...
     * updated to
     *
     * \f$ floatOuts = \left [ \left [ 0.1, 1.1, 2.1 \right ], \left [ 7, -6 \right ], \left [ 0, 1, 2 \right ] \right
     * ]\f$
     *
     * `intOuts` is updated to
     *
     * \f$ intOuts = \left [ \left [ -1, 0, 1 \right ], \left [ 1, 2, 3 \right ], \left [ -5, 6, 7, 8 \right ] \right ]
     * \f$
     *
    ...
    jacobian = {{(x[0] + 1.) * (x[0] - 0.25) * (x[0] + 0.1) + (x[0] - 1.) * (x[0] - 0.25) * (x[0] + 0.1) +
                 (x[0] - 1.) * (x[0] + 1.) * (x[0] + 0.1) + (x[0] - 1.) * (x[0] + 1.) * (x[0] - 0.25)}};
...
errorOut nlFxn6(const floatVector &x, const floatMatrix &floatArgs, const intMatrix &intArgs, floatVector &residual,
                floatMatrix &jacobian, floatMatrix &floatOuts, intMatrix &intOuts) {
    /*!
     * A non-linear function for use in testing the solver which will require
     * the use of the bounded homotopy solver. The function is of the form
     *
     * \f$R = \left [ \left ( x - 1 \right ) \left ( x + 1 \right ) \left ( x - 0.25 \right ) \left ( x + 0.1 \right ),
     * \left ( y - 1 \right ) \left ( y - 1 \right ), \left ( x + 5 \right ) \left ( z + 1 \right ) \right ]\f$
     *
    ...
    floatType dr1dx1 = (x1 - 1) * (x1 - 0.25) * (x1 + 0.1) + (x1 - 1) * (x1 - 0.25) * (x1 + 1) +
                       (x1 - 1) * (x1 + 0.1) * (x1 + 1) + (x1 - 0.25) * (x1 + 0.1) * (x1 + 1);
...
errorOut nlFxn7(const floatVector &x, const floatMatrix &floatArgs, const intMatrix &intArgs, floatVector &residual,
                floatMatrix &jacobian, floatMatrix &floatOuts, intMatrix &intOuts) {
    /*!
     * A non-linear function for use in testing the solver which will require
     * the use of the bounded homotopy solver. The function is of the form
...
errorOut lagrangian1(const floatVector &x, const floatMatrix &floatArgs, const intMatrix &intArgs, floatType &value,
                     floatVector &gradient, floatMatrix &floatOuts, intMatrix &intOuts) {
    /*!
...
errorOut lagrangian2(const floatVector &x, const floatMatrix &floatArgs, const intMatrix &intArgs, floatType &value,
                     floatVector &gradient, floatMatrix &floatOuts, intMatrix &intOuts) {
    /*!
    ...
    gradient = {1 + 2 * _L * _x, 1 + 2 * _L * _y, _x * _x + _y * _y - 1};
...
errorOut lagrangian3(const floatVector &x, const floatMatrix &floatArgs, const intMatrix &intArgs, floatType &value,
                     floatVector &gradient, floatMatrix &floatOuts, intMatrix &intOuts) {
    /*!
     * A lagrangian used to test the optimization tools. The function is of the form
     *
     ...
     * `floatOuts is updated to
     *
     * \f$ floatOuts = \left [ \left [ 1, 2, 3 \right ], \left [ -0.4, -0.5, -0.6 \right ], \left [ 7, 6, 5 \right ]
     * \right ] \f$
     *
     * `intOuts` is updated to
     *
     * \f$ intOuts = \left [ \left [ -4 \right ], \left [ 5, 6, 7 \right ], \left [ 8 \right ], \left [ 9, 10 \right ]
     * \right ] \f$
     *
     * \param &x: A vector of the variable to be solved.
     * \param &floatArgs: Additional floating point arguments to residual
    ...
    gradient = {2 * _x * _y + 2 * _L * _x, _x * _x + 2 * _L * _y, _x * _x + _y * _y - 3};
...
BOOST_AUTO_TEST_CASE(testNewtonRaphson, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    BOOST_TEST(tardigradeVectorTools::appendVectors(J) == tardigradeVectorTools::appendVectors(Jexp),
               CHECK_PER_ELEMENT);
...
BOOST_AUTO_TEST_CASE(testCheckJacobian, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    badfunc = [&](const floatVector &x_, const floatMatrix &floatArgs_, const intMatrix &intArgs_, floatVector &r,
                  floatMatrix &j, floatMatrix &fO, intMatrix &iO) {
...
BOOST_AUTO_TEST_CASE(testHomotopySolver, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    errorOut error =
        tardigradeSolverTools::homotopySolver(func, x0, x, converged, fatalErrorFlag, floatOuts, intOuts, {}, {});
    ...
    error = tardigradeSolverTools::homotopySolver(func, x0, x, converged, fatalErrorFlag, floatOuts, intOuts, {}, {},
                                                  linearSolver, J, variableIndices, barrierSigns, barrierValues, false,
                                                  20, 1e-9, 1e-9, 1e-4, 4, 1.0, 0.1);
...
BOOST_AUTO_TEST_CASE(test_computeBarrierHomotopyResidual, *boost::unit_test::tolerance(1e-5)) {
    ...
    errorOut error = tardigradeSolverTools::computeBarrierHomotopyResidual(func, x0, floatArgs, intArgs, residualResult,
    ...
    error = tardigradeSolverTools::computeBarrierHomotopyResidual(func, x0 + dx, floatArgs, intArgs, rP, JP, floatOuts,
                                                                  intOuts);
    ...
    error = tardigradeSolverTools::computeBarrierHomotopyResidual(func, x0 - dx, floatArgs, intArgs, rM, JM, floatOuts,
                                                                  intOuts);
    ...
    error =
        tardigradeSolverTools::computeBarrierHomotopyResidual(func, x0, floatArgs, intArgs, rP, JP, floatOuts, intOuts);
    ...
    error =
        tardigradeSolverTools::computeBarrierHomotopyResidual(func, x0, floatArgs, intArgs, rM, JM, floatOuts, intOuts);
...
BOOST_AUTO_TEST_CASE(test_computeBarrierHomotopyResidual2, *boost::unit_test::tolerance(1e-5)) {
    ...
    errorOut error = tardigradeSolverTools::computeBarrierHomotopyResidual(func, x, floatArgs, intArgs, residualResult,
                                                                           jacobian, floatOuts, intOuts);
    ...
    error = tardigradeSolverTools::computeBarrierHomotopyResidual(func, x, floatArgs, intArgs, rP, jacobian, floatOuts,
                                                                  intOuts);
    ...
    error = tardigradeSolverTools::computeBarrierHomotopyResidual(func, x, floatArgs, intArgs, rM, jacobian, floatOuts,
                                                                  intOuts);
...
BOOST_AUTO_TEST_CASE(test_barrierHomotopySolver, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    errorOut error =
        tardigradeSolverTools::barrierHomotopySolver(func, dt, x0, variableIndices, residualIndices, barrierSigns,
                                                     barrierValues, logAMaxValues, floatArgs, intArgs, implicitRefine,
                                                     result, convergeFlag, fatalErrorFlag, floatOuts, intOuts, 20, 1e-9,
                                                     1e-9, 1e-4, 5, true);
    ...
    error =
        tardigradeSolverTools::barrierHomotopySolver(func, dt, x0, variableIndices, residualIndices, barrierSigns,
                                                     barrierValues, logAMaxValues, floatArgs, intArgs, implicitRefine,
                                                     result, convergeFlag, fatalErrorFlag, floatOuts, intOuts,
                                                     linearSolver, jacobian, 20, 1e-9, 1e-9, 1e-4, 5, true);
    ...
    error = tardigradeSolverTools::barrierHomotopySolver(func, dt, x0, variableIndices, residualIndices, barrierSigns,
                                                         ...
                                                         floatOuts, intOuts, 20, 1e-9, 1e-9, 1e-4, 5, true);
...
BOOST_AUTO_TEST_CASE(test_applyBoundaryLimitation, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    errorOut error =
        tardigradeSolverTools::applyBoundaryLimitation(x0, variableIndices, barrierSigns, barrierValues, dx);
    ...
    dx    = dxDefault;
    error = tardigradeSolverTools::applyBoundaryLimitation(x0, variableIndices, barrierSigns, barrierValues, dx, 1e-9,
                                                           1e-9, true);
...
BOOST_AUTO_TEST_CASE(test_BFGS, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    floatMatrix floatOutsAnswer = {
        {1,    2,    3   },
        {-0.4, -0.5, -0.6}
    };
    intMatrix intOutsAnswer = {
        {5, 6, 7},
        {8},
        {9, 10}
    };
    ...
    errorOut error =
        tardigradeSolverTools::BFGS(func, x0, x, convergeFlag, fatalErrorFlag, floatOuts, intOuts, floatArgs, intArgs);

    BOOST_CHECK(!error);

    BOOST_TEST(x == xAnswer, CHECK_PER_ELEMENT);

    BOOST_TEST(tardigradeVectorTools::appendVectors(floatOuts) == tardigradeVectorTools::appendVectors(floatOutsAnswer),
               CHECK_PER_ELEMENT);

    BOOST_TEST(tardigradeVectorTools::appendVectors(intOuts) == tardigradeVectorTools::appendVectors(intOutsAnswer),
               CHECK_PER_ELEMENT);
}
...
BOOST_AUTO_TEST_CASE(test_BFGS2, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    errorOut error = tardigradeSolverTools::BFGS(func, x0, x, convergeFlag, fatalErrorFlag, floatOuts, intOuts,
                                                 floatArgs, intArgs, 20, 1e-9, 1e-9, 1e-4, 5, true);
...
BOOST_AUTO_TEST_CASE(test_homotopyBFGS, *boost::unit_test::tolerance(DEFAULT_TEST_TOLERANCE)) {
    ...
    errorOut error =
        tardigradeSolverTools::homotopyBFGS(func, x0, x, convergeFlag, fatalErrorFlag, floatOuts, intOuts, floatArgs,
                                            intArgs, 100, 1e-9, 1e-9, 1e-4, 10, 1.0, 0.1, true, 1.0);
